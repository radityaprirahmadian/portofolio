...
const Index = () => {
  return (
    <Screen>
      <Container topImage={bni} title={'Website Sistem Monitoring Dan Evaluasi KEMENKO PMK'}>
        <div className="section">
          ...
          <div className="section-content">
            ...
            <span className="highlight">will be available in BNI Mobile Apps</span> and used by all
            BNI Mobile Apps users. This feature let{' '}
