...
const Index = () => {
  return (
    <Screen>
      <Container topImage={simonev} title={'Website Sistem Monitoring Dan Evaluasi KEMENKO PMK'}>
        ...
        <div className="section">
          ...
          <div className="section-content">
            ...
            . This website has <span className="highlight">4 users</span> that are basic user,
            admin, super admin, and owner of the website, with different responsibility and access.
            With a lot of features. this website is{' '}
            <span className="highlight">used by more than 600 institutions</span> below KEMENKO PMK.
          </div>
        </div>
        <div className="section">
          ...
          <div className="section-content">
            ...
            <span className="highlight">CSS</span> and <span className="highlight">Bootstrap</span>{' '}
            for styling.
          </div>
        </div>
      </Container>
